...
Project.create(
  ...
  goal: 600,
  end_date: (Date.today + 3.month).strftime("%F"),
  owner_id: "1",
  category_id: "3",
...
Project.create(
  ...
  goal: 300,
  end_date: (Date.today + 50.day).strftime("%F"),
  owner_id: "1",
  category_id: "3",
...
Project.create(
  ...
  goal: 1500,
  end_date: (Date.today + 56.day).strftime("%F"),
  owner_id: "1",
  category_id: "1",
...
Project.create(
  ...
  goal: 200,
  end_date: (Date.today + 32.day).strftime("%F"),
  owner_id: "1",
  category_id: "1",
...
Project.create(
  ...
  goal: 30000,
  end_date: (Date.today + 11.day).strftime("%F"),
  owner_id: "2",
  category_id: "5",
...
Project.create(
  ...
  goal: 400,
  end_date: (Date.today + 44.day).strftime("%F"),
  owner_id: "1",
  category_id: "4",
...
Project.create(
  ...
  goal: 550,
  end_date: (Date.today + 34.day).strftime("%F"),
  owner_id: "1",
  category_id: "2",
...
Project.create(
  ...
  goal: 15000,
  end_date: (Date.today + 24.day).strftime("%F"),
  owner_id: "1",
  category_id: "5",
...
Project.create(
  ...
  goal: 675,
  end_date: (Date.today + 67.day).strftime("%F"),
  owner_id: "1",
  category_id: "2",
...
Project.create(
  ...
  goal: 200000,
  end_date: (Date.today + 46.day).strftime("%F"),
  owner_id: "1",
  category_id: "5",
...
Project.create(
  ...
  goal: 300,
  end_date: (Date.today + 33.day).strftime("%F"),
  owner_id: "1",
  category_id: "2",
